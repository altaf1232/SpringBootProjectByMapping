...
public class Authors {
	...
	public Authors(int author_id, String author_firstName, String author_lastName, String author_address) {
		super();
		this.author_id = author_id;
		this.author_firstName = author_firstName;
		this.author_lastName = author_lastName;
	...
	public String toString() {
		return "Authors [author_id=" + author_id + ", author_firstName=" + author_firstName + ", author_lastName="
